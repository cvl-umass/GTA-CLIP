...
def TransCLIP_solver(support_features, support_labels, val_features, val_labels, query_features, query_labels,
                     clip_prototypes, acc=0.0, initial_prototypes=None, initial_predictions=None, verbose=True):
    """
    ...
    y_hat, query_features, query_labels, val_features, val_labels, support_features, support_labels, neighbor_index, clip_acc = \
    ...
    return z, test_acc_at_best_val, acc, clip_acc
