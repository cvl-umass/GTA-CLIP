...
def get_all_dataloaders(cfg, preprocess):
    ...
    if dataset_name.startswith('imagenet'):
        dataset = dataset_list[dataset_name](cfg['root_path'], cfg['shots'], preprocess=preprocess, train_preprocess=None, test_preprocess=None, load_cache=cfg['load_cache'], load_pre_feat=cfg['load_pre_feat'], gpt_path=cfg['gpt_path'], gpt_path_location=cfg['gpt_path_location'])
