...
class ImageNet():
    ...
    def __init__(self, root, num_shots, preprocess, train_preprocess=None, test_preprocess=None, load_cache=False, load_pre_feat=False, gpt_path=None, gpt_path_location=None):
        ...
        if not load_pre_feat:
            self.test = CustomImageFolder(os.path.join(os.path.join(self.dataset_dir, 'val')), transform=test_preprocess)
